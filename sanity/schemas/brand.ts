...
export const brandSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      options: {
        list: [
          { title: "KPMG", value: "kpmg" },
          { title: "PwC", value: "pwc" },
          { title: "DXC Technology", value: "dxc" },
          { title: "Ralph Lauren", value: "ralphlauren" },
          { title: "Divyasree", value: "divyasree" },
          { title: "MGO India", value: "mgoindia" },
          { title: "Small World", value: "smallworld" },
          { title: "Khoye Raaste", value: "khoyeraaste" },
          { title: "Mello", value: "mello" },
          { title: "Dmentors Dance Academy", value: "dmentors" },
          { title: "Sukoon Wali Qawwali", value: "sukoonqawalli" },
          { title: "Vagdevi Vilas School", value: "vagdevi" },
          { title: "VMS Entertainments", value: "vmsentertainments" },
          { title: "K&S Partners", value: "knspartners" },
          { title: "Go Digit", value: "godigit" },
          { title: "Colt Technologies", value: "colt" },
          { title: "Plain text (name only)", value: "plain" },
        ],
      },
    }),
    defineField({
